...
export default function BottomNav({ active, onChange }) {
  ...
  return (
    <nav className="flex-shrink-0 bg-white border-t border-lavender-100 safe-bottom">
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isActive ? 'text-lavender-600' : 'text-lavender-300'}
              `}
              aria-label={label}
            >
              <div className={`
              ...
              <span className={`text-[10px] font-semibold ${isActive ? 'text-lavender-600' : 'text-lavender-300'}`}>
                {label}
              </span>
            </button>
          );
